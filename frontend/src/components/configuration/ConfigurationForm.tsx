    ...
    case 'concierges': {
      ...
      return <>
        ...
        <Section title={t('configuration.form.contextAndCapabilities')} description={t('configuration.form.contextCapabilitiesDescription')}>
          ...
          <Field label={t('configuration.form.availableToolGroups')} wide hint={t('configuration.form.availableCapabilitiesHint')}><TagsInput values={concierge.tool_groups} suggestions={catalog.tool_groups} onChange={tool_groups => set({ ...concierge, tool_groups, default_tool_groups: concierge.default_tool_groups.filter(item => tool_groups.includes(item)) })} placeholder={t('configuration.form.searchToolGroup')} /></Field>
          <Field label={t('configuration.form.defaultToolGroups')} wide hint={t('configuration.form.defaultCapabilitiesHint')}><TagsInput values={concierge.default_tool_groups} suggestions={concierge.tool_groups} onChange={default_tool_groups => set({ ...concierge, default_tool_groups })} placeholder={t('configuration.form.searchToolGroup')} /></Field>
          <Field label={t('configuration.form.availablePlugins')} wide hint={t('configuration.form.availableCapabilitiesHint')}><TagsInput values={concierge.plugins} suggestions={catalog.plugins} onChange={plugins => set({ ...concierge, plugins, default_plugins: concierge.default_plugins.filter(item => plugins.includes(item)) })} placeholder={t('configuration.form.searchPlugin')} /></Field>
          <Field label={t('configuration.form.defaultPlugins')} wide hint={t('configuration.form.defaultCapabilitiesHint')}><TagsInput values={concierge.default_plugins} suggestions={concierge.plugins} onChange={default_plugins => set({ ...concierge, default_plugins })} placeholder={t('configuration.form.searchPlugin')} /></Field>
        </Section>
